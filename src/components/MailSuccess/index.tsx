...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Gửi thành công"} pages={["MailSuccess"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Cảm ơn bạn rất nhiều vì đã gửi tin nhắn. Chúng tôi kiểm tra email thường xuyên và sẽ cố gắng phản hồi sớm nhất có thể.
              </p>
