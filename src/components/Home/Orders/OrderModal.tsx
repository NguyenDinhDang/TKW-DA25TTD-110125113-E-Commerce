...
const OrderModal = ({ showDetails, showEdit, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div ref={modalRef} className="shadow-7 relative w-full max-w-[600px] h-auto min-h-[242px] py-10 scale-100 transform rounded-[15px] bg-white transition-all flex flex-col justify-center items-center">
          <button
