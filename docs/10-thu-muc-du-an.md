...
graph TD
    ...
    pages --> delivery_schedule[delivery-schedule/page.tsx - Lịch giao hàng]
```
...
### F. Trang Lịch giao hàng (`/delivery-schedule`)
*   **[Calender/orderCalender.tsx](file:///f:/Workspace/E-commerce/src/components/Calender/orderCalender.tsx)**:
    *   *Vị trí trên UI:* Trang Lịch giao hàng, truy cập từ menu Header.
    *   *Nhiệm vụ:* Hiển thị lịch tương tác cho người dùng chọn ngày nhận hàng, nhập ghi chú và đặt lịch. Danh sách lịch đã đặt hiển thị ngay bên dưới.
    *   *Thư viện:* MUI X DateCalendar + dayjs.
